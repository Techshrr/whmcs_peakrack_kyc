...
Version 1.2.0 adds `mod_peakrack_kyc_oauth_states` for Alipay OAuth callback state persistence. Opening the addon page or running the upgrade hook creates the table automatically.
