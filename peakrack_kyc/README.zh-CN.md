...
- `lib/Providers/`：Provider 统一接口、已可用的腾讯云/支付宝/人工审核 Provider，以及 v1.1 预留 Provider 适配器。
...
v1.1 开发分支新增后台系统检查卡片和实名详情页，可查看资料元数据、文件、提交记录、Provider 日志和审计日志。当前分支也新增 `AlipayRealNameInfoProvider`，用于支付宝 OpenAPI V3 预咨询、用户授权回调、授权令牌换取和咨询核验结果处理。
